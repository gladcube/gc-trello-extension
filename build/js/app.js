...
Card = (function(){
  ...
  Object.defineProperty(prototype, '$dummy_textarea', {
    get: function(){
      var ref$;
      return (ref$ = this._$dummy_textarea) != null
        ? ref$
        : this._$dummy_textarea = $("<textarea class='dummy'>").css({
          position: "fixed",
          top: -1000
        });
    },
  ...
  Object.defineProperty(prototype, '$title_anchor', {
    get: function(){
      var ref$;
  ...
  Object.defineProperty(prototype, 'is_current', {
    get: function(){
